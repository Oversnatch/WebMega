 ...
 * @author Ben Alex
 */
public class ACGUsernamePasswordAuthenticationToken extends AbstractAuthenticationToken {
	 ...
	 *
	 */
	public ACGUsernamePasswordAuthenticationToken(Object principal, Object credentials) {
		super(null);
	 ...
	 */
	public ACGUsernamePasswordAuthenticationToken(Object principal, Object credentials,
			Collection<? extends GrantedAuthority> authorities, Usuario oUsuario) {
		super(authorities);
		this.principal = principal;
		this.credentials = credentials;
		this.setDetails(oUsuario);
		super.setAuthenticated(true); // must use super, as we override
	}
