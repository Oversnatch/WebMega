...
public class FuncionLIOP extends FuncionGateway {
	/**
	 * 
	 */
	private static final long serialVersionUID = -1376344568613903403L;
	private static final long TIPO_TRX = 17L;

	private DataInputFcnLIOP dataIn = null;

	public FuncionLIOP(Map<FuncionParam, Object> parametros) throws Exception {
		super(parametros, FuncionName.LIOP);
	...
	public MensajeOutboundGateway ejecutar() {
		...
		DataOutputFcnLIOP oDataOut = null;
		...
		if (!oErr.isHayError()) {
			try {
				...
				oDataOut = new DataOutputFcnLIOP(parametros, this.enviarTrama(trama));
				oDataOut.parseData();
	...
	public DataInputFcnLIOP getDataIn() {
		return dataIn;
	}

	public void setDataIn(DataInputFcnLIOP dataIn) {
		this.dataIn = dataIn;
	}
