...
// Chequea que la fecha sea mayor o igual a hoy
function esMayorIgualHoy(fecha) {
	var hoy = getHoy();
	if (fecha.date < hoy){
		return false;
	}else{
...
// Chequea que la fecha sea mayor a hoy
...
// Chequea que la fecha sea menor o igual a hoy
function esMenorIgualHoy(fecha) {
	var hoy = getHoy();
	if (fecha.date>hoy){
		return false;
	}else{
