var ACGSiteScriptsFCNS = {};
/**
 * 
 */
ACGSiteScriptsFCNS.cambiaFondoMsg = function (idComponente, colorLetra, colorFondo, colorBorde,
		imagen) {
...
ACGSiteScriptsFCNS.productoResize = function () {
	//debugger;
...
ACGSiteScriptsFCNS.puntoVentaResize = function () {
...
ACGSiteScriptsFCNS.monitorPVResize = function () {
	var theHeight = window.innerHeight;
...
ACGSiteScriptsFCNS.cierraPanelProducto = function () {
...
ACGSiteScriptsFCNS.deshabilitaSeleccionMenu = function () {
	$('#admTabMenu .ui-state-active').removeClass('ui-state-active');
}

ACGSiteScriptsFCNS.refreshMonPV = function () {
