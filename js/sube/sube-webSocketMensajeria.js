...
function mensajeriaConnect(){
	...
	//if(webSocketMensajeria == undefined){
		...
		webSocketMensajeria.onerror = function(evt) { SUBE_error_mensajeria(evt) };
		webSocketMensajeria.onmessage = function(evt) { SUBE_message_mensajeria(evt) };
	}
}

function SUBE_error_mensajeria(evt){
	if(debug == "true"){
		debugger;
	}	
...
function SUBE_message_mensajeria(evt){
	if(debug == "true"){
		debugger;
	}	
